...
<head>
    ...
    <style>
        ...
        /* Penyesuaian khusus untuk card registrasi yang lebih tinggi di layar besar */
        @media (min-width: 901px) {
            .register-card {
                /* Mengatur lebar maksimum sedikit lebih besar untuk menampung lebih banyak field */
                max-width: 520px;
            }
        }
    </style>
...
<body>
    <div class="auth-split">
        ...
        <div class="auth-form-side">
            <main class="login-card register-card" role="main" aria-labelledby="register-heading">
                <div class="card-body">
                    ...
                    <form action="<?= BASEURL ?>auth/processRegister" method="POST" class="login-form" autocomplete="off">
                        ...
                        <div class="form-row">
                            <label class="checkbox-inline">
                                <input type="checkbox" name="terms" required> Saya menyetujui <a class="forgot-link" href="#">Syarat & Ketentuan</a>
                            </label>
                        </div>

                        <button type="submit" class="btn btn-login">Daftar Sekarang</button>

                        <p class="signup-note">Sudah punya akun? <a href="<?= BASEURL ?>auth/login">Masuk</a></p>
                    </form>
                </div>
